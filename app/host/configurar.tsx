...
const styles = StyleSheet.create({
  ...
  templateChipActive: { borderColor: '#8E44AD', backgroundColor: '#F3E5F5' },
  ...
  coordsTitle: { fontSize: 13, fontWeight: '700', color: Colors.accent },
  ...
  featuresTitle: { fontSize: 14, fontWeight: '700', color: '#8E44AD', marginBottom: 4 },
