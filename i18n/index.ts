...
const es = {
  ...
  submitLoginRequired: 'Necesitas una cuenta',
  submitLoginRequiredMsg: 'Para enviar un evento necesitas iniciar sesión o crear una cuenta gratuita. Es rápido y sencillo.',
  submitLoginBtn: 'Crear cuenta o iniciar sesión',
...
const en: typeof es = {
  ...
  submitLoginRequired: 'Account required',
  submitLoginRequiredMsg: 'You need to sign in or create a free account to submit an event. It only takes a moment.',
  submitLoginBtn: 'Create account or sign in',
...
const ca: typeof es = {
  ...
  submitLoginRequired: 'Cal un compte',
  submitLoginRequiredMsg: "Per enviar un esdeveniment cal iniciar sessió o crear un compte gratuït. És ràpid i senzill.",
  submitLoginBtn: 'Crear compte o iniciar sessió',
